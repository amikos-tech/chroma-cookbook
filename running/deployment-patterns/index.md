...
1. **Server mode** - Chroma runs as a standalone service and your app connects via HTTP (`HttpClient`)
...
1. Create `app_http.py` and connect with `HttpClient`.
...
1. Set host/port when needed (for example in containers):
...
- [Running Chroma](https://cookbook.chromadb.dev/running/running-chroma/index.md)
- [Health Checks](https://cookbook.chromadb.dev/running/health-checks/index.md)
- [Systemd service](https://cookbook.chromadb.dev/running/systemd-service/index.md)
- [Road To Production](https://cookbook.chromadb.dev/running/road-to-prod/index.md)
