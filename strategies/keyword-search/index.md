...
- [Filters (`where` and `where_document` operators)](https://cookbook.chromadb.dev/core/filters/index.md)
- [Collections (`query` result shape, `include`, ID-constrained query)](https://cookbook.chromadb.dev/core/collections/index.md)
- [Concepts (search stages and query flow)](https://cookbook.chromadb.dev/core/concepts/index.md)
- [Advanced Queries (query-stage semantics and tradeoffs)](https://cookbook.chromadb.dev/core/advanced/queries/index.md)
