...
This page covers local/OSS image search with Chroma using OpenCLIP embeddings.
You can index image URIs and query by:
...
!!! note "Concept Snippet"

    This snippet is intentionally small and may omit setup.
