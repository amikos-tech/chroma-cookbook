...
!!! info "No Built-In Metadata Contract Enforcement"
    ...
    See [Metadata Schema Validation](../strategies/metadata-schema-validation.md).
...
- [Filters](filters.md) for `where` / `where_document` syntax and operators.
- [Advanced Search Semantics](advanced/queries.md#advanced-search-semantics) for execution-stage behavior and tradeoffs.
