...
- [Embeddings](embeddings.md) - use LangChain embedding models with Chroma collections and `langchain_chroma`.
- [Retrievers](retrievers.md) - use LangChain retrievers with Chroma.
